...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="/backendproject2023/index.php">Backend Project</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="/backendproject2023/index.php">index <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
